...
ANALYTICS_HOST="${OPENJARVIS_ANALYTICS_HOST:-https://us.i.posthog.com}"
ANALYTICS_KEY="${OPENJARVIS_ANALYTICS_KEY:-phc_Ci2D9jdphZrzvdpRvoc4KFbKMpvqkkaaQWkxpyQizbqX}"
